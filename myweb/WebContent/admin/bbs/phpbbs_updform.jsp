...
<body>
	...
	* 글 수정 *<br/>
	<%
		...
		phpbbsDto=dao.phpadminupdateform(phpbbsDto);
		if(phpbbsDto==null)
		{
	%>
    ...
    <%
		...
		{
	%>
	<form method="post" action="phpbbs_updok.jsp">
	...
	<input type="hidden" name="nowPage" value="<%=request.getParameter("nowPage")%>">
		...
		<tr>
			...
			<td align="left" class="tabletd"><input type="text" name="writer" value="<%=phpbbsDto.getWriter()%>" size="20" maxlength="20" readonly="readonly"></td>
		</tr>
		<tr>
			<th width="80" height="30" class="tableth">이메일</th>
			<td align="left" class="tabletd"><input type="text" name="email" value="<%=phpbbsDto.getEmail()%>" size="20" maxlength="50" readonly="readonly"></td>
		</tr>
		<tr>
			<th height="30" class="tableth">제목</th>
			<td align="left" class="tabletd"><input type="text" name="subject" size="50" value="<%=phpbbsDto.getSubject()%>"></td>
		</tr>
		<tr>
			<th class="tableth">내용</th>
			<td align="left" class="tabletd"><textarea name="content" rows="10" cols="70"><%=phpbbsDto.getContent()%></textarea></td>
		</tr>
		</table>
		<br/>
