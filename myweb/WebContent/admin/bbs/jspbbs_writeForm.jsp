...
<%@ include file="../../mvc2bbs/view/color.jspf" %>
...
<form method="post" name="writeform" action="/myweb/admin/bbs/writePro.do">
...
<tr>
	...
	<a href="/myweb/admin/bbs/list.do"><img src='../../images/bt_list.gif' border='0'></a>
	</td>
	<td align="center">
