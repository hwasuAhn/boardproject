...
<form method="post" name="writeform" action="/myweb/admin/bbs/updatePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
...
<!-- 	</tr> -->
	...
	<tr>
		...
		<a href="/myweb/admin/bbs/list.do?pageNum=${pageNum}"><img src='../../images/bt_list.gif' border='0'></a>
		</td>
		<td align="center">
