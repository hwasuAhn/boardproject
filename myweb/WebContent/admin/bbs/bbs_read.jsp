...
<body>
	...
	* 글 상세보기 *<br/>
	...
	<br/>
	<form method="post">
		<input type="image" src="../../images/bt_list.gif" onclick="gourl(this.form, 'bbs_list.jsp')">  <!-- 목록 -->
		<input type="image" src="../../images/bt_rep.gif" onclick="gourl(this.form, 'bbs_rep.jsp')"/>  <!-- 답글 -->
		<input type="image" src="../../images/bt_mod.gif" onclick="gourl(this.form, 'bbs_upd.jsp')"/>  <!-- 수정 -->
		<input type="image" src="../../images/bt_del.gif" onclick="gourl(this.form, 'bbs_del.jsp')"/>  <!-- 삭제 -->
