...
<title> member_edit.jsp </title>
<script type="text/javascript">
	function editok(frm) {
		var mess="회원정보가 수정됩니다\n수정할까요?"
		if(confirm(mess))
		{
			frm.submit();
		}
...
<body>
	<div align="center">* 회/원/정/보/수/정 *</div><br/>
	<%
	...
	%>
				...
				<td>
					<form method="post" action="member_editform.jsp">
						<input type="button" value="수정" onClick="editok(this.form)">
	...
	out.print(mgr.paging(nowPage, "member_edit.jsp"));
	out.print("</td></tr>");
	out.print("</table>");
	//-------------------------------------------------
		} 
