...
<form method="post" name="writeform" action="/myweb/mvc2bbs/phpupdatePro.do?pageNum=${pageNum}" onsubmit="return writeSave()">
...
<input type="hidden" name="email" value="${article.email}">
	...
	<tr>
		...
		<td align="left" class="tabletd">${article.writer}</td> 
	</tr>
	<tr>
	...
	<tr>
    	...
    	<td align="left" class="tabletd">${article.email}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<a href="/myweb/mvc2bbs/phplist.do?pageNum=${pageNum}"><img src='../images/bt_list.gif' border='0'></a>
		</td>
		<td align="center">
