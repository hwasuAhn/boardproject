...
<form method="post" name="writeform" action="/myweb/mvc2bbs/phpwritePro.do">
...
<tr>
    ...
    <td align="left" class="tabletd"><b>${memid}</b></td>  
</tr>
<tr>
...
<tr>
	...
	<a href="/myweb/mvc2bbs/phplist.do"><img src='../images/bt_list.gif' border='0'></a>
	</td>
	<td align="center">
