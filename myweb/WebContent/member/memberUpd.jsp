...
<div id="content" align="center">
	...
	* 회원정보 수정 *<br/>
	<form name="myform" method="post" action="memberUpdForm.jsp">
		...
		<tr>
			...
			<td align="left" class="tabletd"><input type="password" name="s_passwd" maxlength="12"></td>
		</tr>
		<tr>
