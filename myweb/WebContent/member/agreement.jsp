...
<div id="content" align="center">
	<!-- agreement.jsp -->
	<!-- 본문 시작 -->
	<img src="../images/j_join.gif"><br/><br/>
<!--
...
<form name="frmAgree" 
           method="post" 
           action="memberForm.jsp" 
           onsubmit="return send()">
<table border="0" cellspacing="0" cellpadding="2"  align="center">
<tr>
<td>
<div style="text-align:left;"><img src="../images/bbs_icon_arr.gif"/>약관동의</div>
</td>
</tr>

    <tr align="center" height="10"> 
        <td>
            <textarea cols="80" rows="14" readonly>Cummunity 서비스약관 (2005. 7. 18 부터 유효)
...
<img src="../images/icon_jum.gif">이용약관에 대하여 모두 동의하십니까? &nbsp;
 <input type="checkbox" name="agree" value="1" > 동의함
 </td>
 <tr>
 <td>
<input type="submit" value="회원가입" class="btn"></input> 
<input type="button" value="취소" class="btn" onclick="javascript:history.back();"></input>
</td>
</tr>
</table>
</form>
  ...
  //자바스크립트는 리턴 타입이 없다.
      ...
      if(frmAgree.agree.checked==false)
      {
