...
<div id="content" align="center">
	<!-- memberForm.jsp -->
	<!-- 본문 시작 -->
	<img src="../images/j_join.gif"><br/><br/><br/>
	* 회원가입 *<br/>
	 <form name="regForm" 
   	               method="post" 
	...
	function zipCheck() {
		var zipwin=window.open("zipCheckForm.jsp", "winzip", "width=450, height=350");
	}
	...
	function idCheck(id) {
		...
		{
			var winid;	
			winid=window.open("idCheckProc.jsp?id="+id, "idwin", "width=250, height=110");
